...
pub fn pdbsequence(path: &str) -> Result<String, Box<dyn Error>> {
...
pub fn euclediancomparativetwo(
    path: &str,
    chain: &str,
    residue1: &str,
    residue2: &str,
...
pub fn eucledianall(path: &str, chain: &str) -> Result<Vec<f32>, Box<dyn Error>> {
